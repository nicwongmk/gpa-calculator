...
const Header = ({ dataFromSetting, decimalPlaces }) => {
        ...
        <header>
            <div className={ styles.container }>
                ...
                <div className={ styles.buttonContainer }>
                    ...
                    { showSetting && <Setting closeSetting={() => setShowSetting((prev) => !prev)} dataFromSetting={ dataFromSetting } decimalPlaces={ decimalPlaces } /> }
